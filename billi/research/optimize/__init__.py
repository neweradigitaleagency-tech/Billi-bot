...
from billi.config import config as jesse_config, set_config
from billi.research.monte_carlo.common import DEFAULT_CPU_USAGE_RATIO, MIN_CPU_CORES
...
def optimize(
    ...
    try:
        ...
        from billi.modes.optimize_mode.Optimize import ray_evaluate_trial  # noqa: PLC0415
