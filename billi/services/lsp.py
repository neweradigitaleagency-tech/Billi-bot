...
def _save_lsp_version(lsp_version: str) -> None:
    ...
    """
    from billi import billi_DIR
    version_file = os.path.join(BILLI_DIR, 'lsp', 'VERSION')
...
def install_lsp_server() -> None:
    ...
    target_dir = os.path.join(BILLI_DIR, 'lsp')
...
def run_lsp_server():
    ...
    from billi import billi_DIR
    lsp_dir = os.path.join(BILLI_DIR, 'lsp')
    ...
    jesse_framework_parent = os.path.dirname(BILLI_DIR)  # /home/king/jesse/jesse-ai/jesse    
