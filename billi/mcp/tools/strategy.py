...
def register_strategy_tools(mcp):
    ...
    def create_strategy(name: str, content: str) -> dict:
        ...
        Content Requirements:
            - Must import Strategy: `from billi.strategies import Strategy`
            - Must import indicators: `import billi.indicators as ta`
            - Must import utilities: `from billi import utils`
    ...
    def read_strategy(name: str) -> dict:
        ...
        Returns:
            ...
            Success Response:
            {
                ...
                "content": "from billi.strategies import Strategy\\nimport jesse.indicators as ta\\nfrom jesse import utils\\n\\nclass RSIStrategy(Strategy):\\n    def should_long(self) -> bool:\\n        return False\\n    # ... full strategy code"
            }
