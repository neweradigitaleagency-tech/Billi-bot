...
3. Import and register in this file:
   from billi.mcp.tools.my_tools import register_my_tools
   Then call: register_my_tools(mcp) in register_tools()

ACCESSING JESSE API URL:
------------------------
import billi.mcp.tools as tools_module
...
from billi.mcp.tools.strategy import register_strategy_tools
from billi.mcp.tools.backtest import register_backtest_tools
from billi.mcp.tools.config import register_config_tools
from billi.mcp.tools.candles import register_candles_tools
from billi.mcp.tools.indicator import register_indicator_tools
