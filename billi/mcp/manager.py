...
def run_mcp_server(billi_host:str, billi_port:int) -> None:
    """
    ...
    import billi.mcp.mcp_config as mcp_config
    
    # define the billi api url
    mcp_config.JESSE_API_URL = f"http://{billi_host}:{billi_port}"
