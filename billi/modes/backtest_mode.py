...
import billi.services.metrics as stats
from billi import exceptions
from billi.config import config
from billi.enums import timeframes, order_types
from billi.models import Order, Position
from billi.modes.utils import save_daily_portfolio_balance
from billi.candle_pipelines import BaseCandlesPipeline
from billi.routes import router
from billi.services import charts
from billi.services import report
from billi.services import candle_service
from billi.services.file import store_logs
from billi.services.validators import validate_routes
from billi.store import store
from billi.services import logger
from billi.services.failure import register_custom_exception_handler
from billi.services.redis import sync_publish, is_process_active
from billi.services import order_service
from timeloop import Timeloop
from datetime import timedelta
from billi.services.progressbar import Progressbar
from billi.constants import TIMEFRAME_TO_ONE_MINUTES
from billi.services import candle_service, order_service, position_service, exchange_service
...
def _execute_backtest(
    ...
    """
    from billi.config import set_config
    ...
    if not jh.should_execute_silently():
        from billi.models.BacktestSession import store_backtest_session
    ...
    try:
        ...
        if not jh.should_execute_silently():
            import traceback
            from billi.models.BacktestSession import store_backtest_session_exception, update_backtest_session_status
    ...
    if result and not jh.should_execute_silently():
        ...
        from billi.models.BacktestSession import update_backtest_session_results, update_backtest_session_status
