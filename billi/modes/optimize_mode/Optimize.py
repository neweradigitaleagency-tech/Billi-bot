...
from billi.services.redis import sync_publish
from billi.modes.optimize_mode.fitness import get_fitness
from billi.routes import router
from billi.services.progressbar import Progressbar
from billi.services.redis import is_process_active
from billi.models.OptimizationSession import update_optimization_session_status, update_optimization_session_trials, get_optimization_session, get_optimization_session_by_id
import traceback
...
class Optimizer:
    ...
    def run(self) -> optuna.trial.FrozenTrial:
        ...
        try:
            ...
            update_optimization_session_status(self.session_id, 'stopped')
            from billi.models.OptimizationSession import add_session_exception
