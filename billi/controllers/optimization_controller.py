...
from billi.services.multiprocessing import process_manager
from billi.services.web import OptimizationRequestJson, CancelRequestJson, UpdateOptimizationSessionStateRequestJson, UpdateOptimizationSessionStatusRequestJson, TerminateOptimizationRequestJson, UpdateOptimizationSessionNotesRequestJson, GetOptimizationSessionsRequestJson
from billi import helpers as jh
from billi.models.OptimizationSession import get_optimization_sessions as get_sessions, update_optimization_session_state, update_optimization_session_status, delete_optimization_session, reset_optimization_session, update_optimization_session_notes, purge_optimization_sessions, get_running_optimization_session_id
from billi.services.transformers import get_optimization_session, get_optimization_session_for_load_more
from billi.models.OptimizationSession import get_optimization_session_by_id as get_optimization_session_by_id_from_db
from billi.modes.optimize_mode import run as run_optimization
...
def download_optimization_log(token: str = Query(...)):
    ...
    from billi.modes import data_provider
